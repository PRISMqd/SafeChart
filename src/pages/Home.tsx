...
const modules = [
  ...
  },
  {
    ...
    subtitle: 'Narrative, Internal Chain & Retaliation',
    description: 'Document your narrative, internal chain of command, escalation attempts, witness records, and retaliation indicators.',
    path: '/module3',
    icon: '📋',
  },
  {
    id: 4,
    title: 'Module 4: Residual Risk',
    subtitle: 'Post-Escalation Risk Documentation',
    description: 'Document what patient safety risk remains unresolved after escalation. Creates a clear record that risk was reported and not remediated.',
    path: '/module4',
    icon: '⚠️',
  },
  {
    id: 5,
    title: 'Module 5: Sitter / Safety Attendant',
    subtitle: 'Monitoring Need & Removal Documentation',
    description: 'Document safety attendant needs, removal or denial, internal escalation chain, and your documented objection.',
    path: '/module5',
    icon: '👁️',
  },
  {
    id: 6,
    title: 'Module 6: Adverse Response Index',
    subtitle: 'ARI Professional Self-Assessment',
    description: 'Contemporaneous professional assessment of cognitive load, fatigue, moral distress, retaliation fear, and physical capacity under current conditions.',
    path: '/module6',
    icon: '🧠',
  },
  {
