...
export default function Module3_Escalation() {
  ...
  const addEscalation = () => {
    if (!current.attemptTime || !current.reportedTo) return;
    setEscalations(prev => [...prev, current]);
    setCurrent(emptyEsc());
    setShowForm(false);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <h2 className="font-heading font-bold text-navy text-lg mb-3">Your Narrative</h2>
        ...
        {classification && classification.matches.length > 0 && (
          <div className="mt-4 space-y-2">
            ...
            <div className="mt-2">
              <Badge variant={classification.severityTier === 'critical' ? 'red' : classification.severityTier === 'high' ? 'red' : classification.severityTier === 'moderate' ? 'yellow' : 'green'}>
        ...
        {showForm && (
          <div className="mt-3 p-4 bg-warm rounded-lg border border-gray-200 space-y-3">
            ...
            <div className="flex gap-2">
              <Button variant="teal" size="sm" onClick={addEscalation}>Add Entry</Button>
